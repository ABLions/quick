<?php
	...
	require_once ("../connection.php");//Contiene funcion que conecta a la base de datos
    ...
    $sql = "INSERT INTO tblproduct(id, prod_code, prod_name, prod_ctry, prod_qty, price) VALUES (NULL,'$prod_code','$prod_name','$prod_ctry','$stock','$price')";
    $query = mysqli_query($con,$sql);
    // if product has been added successfully
    if ($query) {
        $messages[] = "The product has been saved successfully.";
    } else {
